...
#ifndef NAM_DRIVER_LORA_E32_H_
#define NAM_DRIVER_LORA_E32_H_
...
#define LORA_TX_PORT        gpioPortD
#define LORA_TX_PIN         4
#define LORA_RX_PORT        gpioPortD
#define LORA_RX_PIN         5
#define LORA_M0_PORT        gpioPortC
