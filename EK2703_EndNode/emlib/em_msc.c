...
msc_Return_TypeDef
mscStatusWait (uint32_t mask, uint32_t value)
{
...
MSC_RAMFUNC_DEFINITION_BEGIN
msc_Return_TypeDef
writeBurst (uint32_t address, const uint32_t *data, uint32_t numBytes)
{
 ...
 ******************************************************************************/
MSC_Status_TypeDef
MSC_WriteWordDma (int ch, uint32_t *address, const void *data,
                  uint32_t numBytes)
{
 ...
 ******************************************************************************/
static void
mscEccReadWriteExistingPio (const MSC_EccBank_Typedef *eccBank)
{
 ...
 ******************************************************************************/
static void
mscEccBankInit (const MSC_EccBank_Typedef *eccBank, uint32_t dmaChannels[2])
{
 ...
 ******************************************************************************/
static void
mscEccBankDisable (const MSC_EccBank_Typedef *eccBank)
{
 ...
 ******************************************************************************/
void
MSC_EccConfigSet (MSC_EccConfig_TypeDef *eccConfig)
{
  unsigned int cnt;
 ...
 ******************************************************************************/
void
MSC_DmemPortMapSet (MSC_DmemMaster_TypeDef master, uint8_t port)
{
 ...
 ******************************************************************************/
void
MSC_PortSetPriority (MSC_PortPriority_TypeDef portPriority)
{
  EFM_ASSERT(
...
MSC_PortGetCurrentPriority (void)
{
  uint32_t port = 0;
